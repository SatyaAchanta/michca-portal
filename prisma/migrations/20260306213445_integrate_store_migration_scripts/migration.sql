/*
  ...
  - You are about to drop the `StoreListing` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `StoreListingImage` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "StoreListing" DROP CONSTRAINT "StoreListing_userProfileId_fkey";

-- DropForeignKey
ALTER TABLE "StoreListingImage" DROP CONSTRAINT "StoreListingImage_listingId_fkey";

-- DropTable
DROP TABLE "StoreListing";

-- DropTable
DROP TABLE "StoreListingImage";

-- DropEnum
DROP TYPE "GearCondition";

-- DropEnum
DROP TYPE "StoreListingStatus";
